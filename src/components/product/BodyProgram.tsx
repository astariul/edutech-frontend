...
import { Button, Paper, Transition, Divider } from '@mantine/core';
        ...
        {(styles) => (
          ...
          >
            <div className={classes.programImage}>
              <img src={require("../../static/image/product/program.png")} alt="program" />
            </div>
          </Paper>
        )}
      </Transition>
...
const MentorCard = ({image, nameAndPosition, company, comment}: MentorCardProps) => {
    ...
    <div className={cx(classes.rowFlex, classes.mentorCard)}>
      <div className={cx(classes.rowFlex, classes.mentorCardInner)}>
        ...
        <div className={cx(classes.columnFlex, "mentorCardMentorInfo")}>
          <div className={cx(classes.columnFlex, "mentorCardMentorNameAndPosition")}>
            {nameAndPosition}
            <br />{company}
          </div>
        ...
        <div className={classes.contents}>
          <div className={cx(classes.answer, classes.desktop)}>
            <h2>
              ...
              <br />프로그램을 완벽하게 완성시켰기 때문입니다.
            </h2>
          </div>
          <div className={cx(classes.answer, classes.mobile)}>
            <h2>
              기업이 원하는 인재를 만들기 위해
              <br /><span> 업계 최고 개발자 슈퍼멘토</span>들의
              <br />적극적인 참여로 프로그램을 완벽하게
              <br />완성시켰기 때문입니다.
            </h2>
          </div>
          <Divider size={53} style={{borderTopColor: "transparent"}}/>
          <div className={classes.desktop}>
            <img src={require("../../static/image/product/superMentor.png")} alt="mentor" />
          </div>
          <div className={classes.mobile}>
            <img src={require("../../static/image/product/superMentorMobile.png")} alt="mentor" />
          </div>
          ...
          <section className={classes.desktop}>
            ...
            <img src={require("../../static/image/product/techStacks.png")} alt="techStacks" />
            <Divider size={55} style={{borderTopColor: "transparent"}}/>
            <span className={classes.quotes}>
              <h2>“오래된 강의를 듣지 마시고 최신 현업 기술스택의 강의를 수강하세요.”</h2>
            </span>
            ...
            <div className={cx(classes.rowFlex, classes.cardArea)}>
              <MentorCard
                ...
                comment={<p>슈퍼코딩은 <strong>현업에 꼭 필요한 기술</strong>들만 알기 쉽게 알려줍니다.</p>}
              />
              <MentorCard
                ...
                company= "Krafton"
                comment={
                  <p><strong>현업에서 필요로하는 기술 스택을 쌓을 수 있는 좋을 기회</strong>를 제공해주는 서비
                  <br />스이며 취준생들의 만족도가 가장 높은 코딩 교육이라고 생각합니다.</p>
                }
              />
            </div>
            <Divider size={55} style={{borderTopColor: "transparent"}}/>
            ...
            <div className={cx(classes.rowFlex, classes.cardArea)}>
              <MentorCard
                ...
                comment={<p>기존에 재미없고 어려운 강의만 듣고 '나는 개발에 소질이 없다'고 생각하며 돌
                  <br />아서시시는 모든 분들께 추천합니다.<strong> 여러분이 문제가 아니라 그 동안의 코딩 교육</strong>
                  <br />이 문제였던 것이라는 걸 아시게 될 겁니다.</p>
                }
              />
              <MentorCard
                ...
                comment={
                  <p><strong>비전공자출신으로서</strong>잘못된 강의로 공부하여 일주일이면 공부할 수 있는 내용
                  <br />을 한달 동안 혼자서 씨름해야하는 경우가 태산이었습니다.
                  <br />수퍼코딩은 이 문제점을 정확히 직시하고 해결해줍니다.</p>
                }
              />
            </div>
            <Divider size={55} style={{borderTopColor: "transparent"}}/>
            ...
            <div className={cx(classes.rowFlex, classes.cardArea)}>
              <MentorCard
                ...
                company= "에이블리"
                comment={<p>실제로 <strong>회사에서 개발하는 방식 그대로</strong> 배우실 수 있으십니다.</p>}
              />
              <MentorCard
                ...
                company= "Lunit"
                comment={
                  <p>수강생분들이 슈퍼코딩 과정을 통해 정말로 준비되었다는 느낌을 받으실 수 있
                  <br />을 것 같습니다. <strong>단순히 지식을 전달하는 것 이상으로 적극적으로 도움</strong>받는 느
                  <br />낌입니다.</p>
                }
              />
            </div>
            ...
            <div className={cx(classes.rowFlex, classes.cardArea)}>
              <MentorCard
                ...
                company= "Flesky"
                comment={<p>Supercoding has a team of highly-skilled people that can definitively
                          <br />provide invaluable experience and insights for getting a job as a
                          <br />developper. Learning from them will give you an important leverage and
                          <br />will help you get better as a software engineer.</p>
                }
              />
              <MentorCard
                ...
                company= "Spacewalk"
                comment={
                  <p>직접제작한 강의와 체계화된 커리큘럼으로 수강자를 올바른 방향으로 이끌고
                  <br />취업까지 이어지도록 멘토링해주는 슈퍼 코딩을 기존 코딩 교육으로 만족하지
                  <br />분들께 추천합니다.</p>
                }
              />
            </div>
            ...
            <div className={cx(classes.rowFlex, classes.cardArea)}>
              ...
              <MentorCard
                ...
                company= "CJ 올리브네트웍스"
                comment={
                  <p>최고 수준의 현업 개발자에게 받는 추천보다 취업에 있어 강력한 무기는
                  <br />없습니다.</p>
                }
              />
            </div>
          ...
          <section className={cx(classes.columnFlex, classes.mobile)}>
            <Divider size={83} style={{borderTopColor: "transparent"}}/>
            <SuperMessage
              mainMessage={<>1. 많은 회사에서 실제로 <br />요구하는 기술을 배워야 합니다.</>}
              subMessage={<>많은 취준생분들이 실제 현업에서 <br />사용하는 기술을 배우지 못해 <br />어려움을 겪고 있습니다.</>}
            />
            <Divider size={43.51} style={{borderTopColor: "transparent"}}/>
            <img src={require("../../static/image/product/techStacks.png")} alt="techStacks" />
            <Divider size={33} style={{borderTopColor: "transparent"}}/>
            <span className={classes.quotes}>
              <h2>“오래된 강의를 듣지 마시고 <br />최신 현업 기술스택의 <br />강의를 수강하세요.”</h2>
            </span>
            <Divider size={33} style={{borderTopColor: "transparent"}}/>
            <div className={cx(classes.columnFlex, classes.cardArea)}>
              <MentorCard
                ...
                company= "Meta (Facebook)"
                comment={
                <p>슈퍼코딩은 <strong>현업에 꼭 필요한 기술</strong>
                <br />들만 알기 쉽게 알려줍니다.</p>}
              />
              <MentorCard
                image={require("../../static/image/product/mentors/krafton.png")}
                ...
                company= "Krafton"
                comment={
                  <p><strong>현업에서 필요로하는 기술 스택을
                  <br /> 쌓을 수 있는 좋을 기회</strong>를
                  <br /> 제공해주는 서비스이며
                  <br />취준생들의 만족도가 가장
                  <br />높은 코딩 교육이라고 생각합니다.</p>
                }
              />
            </div>
            <Divider size={55} style={{borderTopColor: "transparent"}}/>
            ...
            <div className={cx(classes.columnFlex, classes.cardArea)}>
              <MentorCard
                ...
                nameAndPosition="이가영 연구원"
                company= "NAVER WEBTOON"
                comment={<p>기존에 재미없고 어려운 강의만
                  <br />듣고 '나는 개발에 소질이 없다'
                  <br />고 생각하며 돌아서시시는 모든 분들께
                  <br />추천합니다.<strong> 여러분이 문제가 아니라
                  <br />그 동안의 코딩 교육</strong>이 문제였던 것
                  <br />이라는 걸 아시게 될 겁니다.</p>
                }
              />
              <MentorCard
                image={require("../../static/image/product/mentors/legionCollective.png")}
                ...
                company= "Legion Collective"
                comment={
                  <p><strong>비전공자출신으로서</strong> 잘못된 강의로
                  <br />공부하여 일주일이면 공부할 수 있는
                  <br />내용을 한달 동안 혼자서 씨름해야하는
                  <br />경우가 태산이었습니다.
                  <br />수퍼코딩은 이 문제점을 정확히
                  <br />직시하고 해결해줍니다.</p>
                }
            ...
            <div className={cx(classes.columnFlex, classes.cardArea)}>
              <MentorCard
                ...
                nameAndPosition="김재오 DevOps Engineer"
                company= "에이블리"
                comment={<p>실제로 <strong>회사에서 개발하는
                         <br />방식 그대로</strong> 배우실 수 있으십니다.</p>}
              />
              <MentorCard
                image={require("../../static/image/product/mentors/lunit.png")}
                nameAndPosition="신희재 Engineer"
                company= "Lunit"
                comment={
                  <p>수강생분들이 슈퍼코딩 과정을 통해
                  <br />정말로 준비되었다는 느낌을 받으실 수 있
                  <br />을 것 같습니다. <strong>단순히 지식을
                  <br />전달하는 것 이상으로 적극적으로
                  <br />도움</strong>받는 느낌입니다.</p>
                }
              />
            </div>
            <Divider size={55} style={{borderTopColor: "transparent"}}/>
            ...
            <div className={cx(classes.columnFlex, classes.cardArea)}>
              <MentorCard
                ...
                company= "Flesky"
                comment={<p>Supercoding has a team of
                          <br />highly-skilled people
                          <br />that can definitively provide
                          <br />invaluable experience and insights
                          <br />for getting a job as a developper.
                          <br />Learning from them will give you
                          <br />an important leverage and will help
                          <br />you get better as a software
                          <br />engineer.</p>
                }
              />
              <MentorCard
