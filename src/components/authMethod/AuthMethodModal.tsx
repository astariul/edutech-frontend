...
const AuthMethodButton = ({ image, title, onClick }: AuthMethodButtonProps) => {
      ...
      <div className={classes.contents}>
        <div className={classes.title}>
          <a href="/">
            <img
              ...
              src={require("../../../src/static/image/supercodinglogo.png")}
              alt="supercodiong logo"
            />
          </a>
        ...
        <div className={classes.methodContainer}>
          ...
          <AuthMethodButton
            ...
            title={"이메일로 시작하기"}
            onClick={() =>
              navigate(authType === "로그인" ? "/login/form" : "/signup/form")
            }
          />
        </div>
        <div
