    ...
    <div className={cx(classes.main, classes.columnFlex)}>
      ...
      <div className={cx(classes.columnFlex, classes.cardBody)}>
        ...
        <div className="courseMeta">
          <div className={cx(classes.rowFlex, "durationAndStudent")}>
            <div className={cx(classes.rowFlex, "duration")}>
              <img
                src={require("../../static/image/freeCourse/clockIcon.png")}
                alt="clock"
              />
            ...
            <div className={cx(classes.rowFlex, "student")}>
              <img
                src={require("../../static/image/freeCourse/profileIcon.png")}
        ...
        <div className={cx(classes.columnFlex, "priceArea")}>
          ...
          <Button radius={4}>무료특강 수강신청하기</Button>
        </div>
      </div>
    </div>
  );
...
const BodyMiddle = () => {
  ...
  const cards = [
    ...
    },
    {
      ...
      cardTitle: {
        desktop:
          "개발자 취업, 나도 가능할까? 인사담당자와 개발 1년차 선배들이 알려주는 리얼 현실을 알려드립니다.",
        mobile: (
          <>
            개발자 취업, 나도 가능할까? 인사담당자와 <br />
            개발 1년차 선배들이 알려주는 리얼 현실을 <br />
            알려드립니다.
          </>
        ),
      },
      ...
      duration: "45",
      recommendation: [
        "개발자로 취업하고 싶은데 뭘 해야 할지 모르겠는 대학생",
        "코딩이 무서운 비전공자 취준생",
        "채용 공고를 봐도 무슨말인지 모르겠는 취준생",
        "개발자로 전직하고 싶은 직장인",
      ],
      originPrice: "100,000",
      discountedPrice: "0",
    },
    {
      ...
      cardTitle: {
        desktop:
          "SI 기업 합격자 이력서 분석 첫 직장을 추천해드리고, 합격하는 이력서를 공개합니다.",
        mobile: (
          <>
            SI 기업 합격자 이력서 분석 첫 직장을 <br />
            추천해드리고, 합격하는 이력서를 <br />
            공개합니다.
          </>
        ),
    ...
    },
    {
      ...
      cardTitle: {
        desktop:
          "면접에 꼭 나오는 대표 질문 Best 10 IT 기업에 필요한 인재는 이런 것! 면접 질문리스트와 출제자의 의도를 알려드립니다.",
        mobile: (
          <>
            면접에 꼭 나오는 대표 질문 Best 10 IT 기업에 <br />
            필요한 인재는 이런 것! 면접 질문리스트와 <br />
            출제자의 의도를 알려드립니다.
          </>
        ),
      },
    ...
    },
    {
      ...
      cardTitle: {
        desktop:
          "코딩테스트, 출제자의 의도가 중요해! 출제 의도와 쉽게 해결하는 방법을 알려드립니다.",
        mobile: (
          <>
            코딩테스트, 출제자의 의도가 중요해! <br />
            출제 의도와 쉽게 해결하는 방법을 <br />
            알려드립니다.
          </>
        ),
      },
