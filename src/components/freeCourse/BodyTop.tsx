    ...
    <div className={cx(classes.contents, classes.columnFlex)}>
      ...
      <section className={classes.featureMessageArea}>
        <div className={classes.featureMessage}>
          <li>
            <span className={classes.emphasizer}>비전공자</span>인데 정말 쉽게
            배워서 개발자가 될 수 있을까?{" "}
          ...
          <li>
            어렵기만한 <span className={classes.emphasizer}>채용공고</span> 어떤
            회사가 내 수준에 맞을까?{" "}
            <span className={classes.hashTag}>
              #나에게맞는 회사고르는 팁 #취업코칭
            </span>
...
const Bottom = () => {
  ...
  return (
    ...
    >
      <div
        className={cx(classes.rowFlex, "bottomMessageLarge", classes.desktop)}
      >
        슈퍼코딩이 만들면 비전공자를 위한
        <br />
        취업 전용 0원 강의도 다릅니다.
      ...
      <div
        className={cx(classes.rowFlex, "bottomMessageLarge", classes.mobile)}
      >
        슈퍼코딩이 만들면
        <br />
        비전공자를 위한 취업전용
      ...
      >
        <span>
          최소 수백만 원에서 수천만 원의 비용, 수백월 시간의 시행착오는 없어야
          합니다.
          <br />
          비용을 지불하기 전에 <strong>취업 전용 최신 강의를 무료</strong>로
          체험해보세요.
        </span>
      </div>
      <div
        className={cx(classes.columnFlex, "bottomMessageSamll", classes.mobile)}
      >
        최소 수백만 원에서 수천만 원의 비용,
        <br />
        수백월 시간의 시행착오는 없어야 합니다.
        <br />
        비용을 지불하기 전에 <strong>취업 전용 최신 강의를</strong>
        <br />
        <strong>무료</strong>로 체험해보세요.
      </div>
    </div>
  );
};
